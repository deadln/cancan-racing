...
Для запуска Симулятора в режиме Любительской лиги с планерами вертикального взлета и посадки выполните команду

```
./formation.sh nonprof vtol
```

Для запуска Симулятора в режиме Любительской лиги с квадрокоптерами выполните команду

```
./formation.sh nonprof mc
```

Для запуска Симулятора в режиме Профессиональной лиги с планерами вертикального взлета и посадки выполните команду

```
./formation.sh prof vtol
```

Для запуска Симулятора в режиме Профессиональной лиги с квадрокоптерами выполните команду
